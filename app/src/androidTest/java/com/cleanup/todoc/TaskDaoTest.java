...
public class TaskDaoTest {
    ...
    private final Task TASK = new Task(projects[0].getId(), projects[0].getId(), "Appeler le client", new Date().getTime());
    ...
    public void test_InsertAndCompareListofTask() throws InterruptedException {
        ...
        Task task0 = new Task(projects[0].getId(), projects[0].getId(),"Appeler le client", new Date().getTime());
        Task task1 = new Task(projects[1].getId(), projects[1].getId(), "Ajouter un header sur le site", new Date().getTime());
        Task task2 = new Task(projects[2].getId(), projects[2].getId(),"Modifier la couleur des textes", new Date().getTime());
